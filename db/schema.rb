...
ActiveRecord::Schema.define(version: 2020_07_20_091538) do
  ...
  create_table "meetings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "user_id"
    t.integer "area"
    t.string "bar"
    t.string "url"
